...
public enum ErrorCode {
  ...
  FILE_SIZE_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST),
  FILE_EXTRACTION_FAILED(HttpStatus.BAD_REQUEST),
  EMPTY_DOCUMENT(HttpStatus.BAD_REQUEST),
  DOCUMENT_NOT_FOUND(HttpStatus.NOT_FOUND),
  DOCUMENT_VERSION_CONFLICT(HttpStatus.CONFLICT),
  INGESTION_RETRY_CONFLICT(HttpStatus.CONFLICT),
